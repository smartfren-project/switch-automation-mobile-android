...
public class LoginITest extends TestSetup {
    ...
    @Test(priority = 251, description = "Switch_Login_001 - User able to pass HOMEPAGE from VALID LOGIN EMAIL")
    ...
    @Test(priority = 252, description = "Switch_Login_002 - User able to pass HOMEPAGE from VALID LOGIN SWITCH NUMBER")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 253, description = "Switch_Login_003 - User unable to pass HOMEPAGE from INVALID LOGIN UNREGISTERED EMAIL")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 254, description = "Switch_Login_004 - User unable to SIGN UP using registered email")
    ...
    @Test(priority = 255, description = "Switch_Login_005 - User unable to click button SUBMIT LOGIN when input False EMAIL Specification")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 256, description = "Switch_Login_006 - User unable to click button SUBMIT LOGIN when input LESS THAN 8 NUMBER")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 257, description = "Switch_Login_007 - User unable to click button SUBMIT LOGIN when input NUMBER with String")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 258, description = "Switch_Login_008 - User unable to click button SUBMIT LOGIN when input Email Less Than 8 Character")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 259, description = "Switch_Login_009 - User unable to login using INVALID PIN EMAIL")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 260, description = "Switch_Login_010 - User unable to login using INVALID PIN SWITCH NUMBER")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 261, description = "Switch_Login_011 - User unable to login using INVALID SWITCH NUMBER")
    @Severity(SeverityLevel.CRITICAL)
    @Description("User Unable to Login Using WRONG PIN From SWITCH NUMBER")
    @Story("Story Name : Check Credential")
