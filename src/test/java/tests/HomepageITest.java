...
public class HomepageITest extends TestSetup {
    ...
    @Test(priority = 65, description = "Switch_Home_002 - User unable to go to All Menu Page")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 66, description = "Switch_Home_003 - User able to check detail plan")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 67, description = "Switch_Home_004 - User able to check balance remaining")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 68, description = "Switch_Home_005 - User able to check sms remaining")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 69, description = "Switch_Home_006 - User able to check call remaining")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 70, description = "Switch_Home_007 - User able to check custom now")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 71, description = "Switch_Home_008 - User able to check big mission")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 72, description = "Switch_Home_009 - User able to check e-commerce")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 73, description = "Switch_Home_010 - User able to check data remaining")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 74, description = "Switch_Home_011 - User able to check mix and max")
    @Severity(SeverityLevel.NORMAL)
