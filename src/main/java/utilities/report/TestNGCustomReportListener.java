...
//import utilities.setup.CommonConfig;
//
//import java.io.*;
...
//import java.util.*;
//
//public class TestNGCustomReportListener extends CommonConfig implements IReporter {
//    private PrintWriter writer;
//    private int m_row;
//    private Integer m_testIndex;
//    private int m_methodIndex;
//    private String reportTitle = "Tiket Android-Automation Report";
//    private String reportFileName = "custom-report.html";
//    private String report = "Android Automation Summary : " + "\n";
//
//    /**
...
////            String destination = baseDirPath + "test-output";
////            File directoryToZip = new File(destination);
...
////            //SendMail.execute("custom-report.html");
////            //System.out.println("Email Sent");
////        } catch (Exception e) {
////            Reporter.log("Failed to send mail");
////        }
////        SlackWebApiClient webApiClient = SlackClientFactory.createWebApiClient("xoxp-5171696313-240771452695-325242492101-8afc6e96f11478c873bd4cf1f664f65b");
////        //Paramters :- java.io.File file, String filetype, String filename, String title, String initial_comment, String channels
////        webApiClient.uploadFile(new File("/Users/priyaljain/Workspace/TiketAutomation/android-automation/test-output/custom-report.html"), "html", "Report", "Android Automation", report, "@priyal.jain");
//    }
//
//
...
//        writer.println("<tr><th>Test Name</th>"
...
//        tableColumnStart("Total<br/>Executed");
//        tableColumnStart("Tests<br/>Passed");
//        tableColumnStart("Skipped");
//        tableColumnStart("Failed");
//        tableColumnStart("Device Name <br/>Android Version");
////        tableColumnStart("Headless");
...
//                summaryCell(environment, true);
//                int q = getMethodSet(overview.getFailedTests(), suite).size() + getMethodSet(overview.getPassedTests(), suite).size() + getMethodSet(overview.getSkippedTests(), suite).size();
...
//                m_testIndex++;
//            }
//            report = report + "Total Test : " + SuiteListener.totalTC + ",\nPassed: " + qty_pass_m + ",  Skipped :" + qty_skip + ",  Failed: " + qty_fail + ".";
//        }
//        if (qty_tests > 1) {
...
////        writer.println("<center><img src=\"https://www.tiket.com/assets_version/cardamom/dist/images/tiketcom.png\" width=\"220\" height=\"60\"></center>");
////        writer.print("<center><h1>" + title + " - " + getDateAsString() + "</h1></center>");
//        writer.println("<center><img src=\"https://www.tiket.com/assets_version/cardamom/dist/images/tiketcom-tematic.png\" width=\"180\" height=\"70\"></center>");
//        writer.print("<center><h1>" + title + " - " + getDateAsString() + "</h1></center>");
//    }
//
//
...
//        out.println("<head>");
//
//        out.println("<title>Tiket Automation Report</title>");
...
//        out.println("<center><img src=\"https://www.tiket.com/assets_version/cardamom/dist/images/tiketcom.png\" width=\"220\" height=\"60\"></center>");
//        out.println("<center> Tiket Automation Report </center>");
